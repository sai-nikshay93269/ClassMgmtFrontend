import { Avatar, Box, Typography, IconButton, Button, Stack, Dialog } from '@mui/material';
...
import ProjectsDialog from './ProjectsDialog'; // Import the new component
                ...
                <Stack onClick={() => { dispatch(ToggleSidebar()); }} direction={'row'} spacing={2} sx={{ cursor: 'pointer' }}>
                    <Box>
                        <StyledBadge overlap="circular" anchorOrigin={{ vertical: "bottom", horizontal: "right" }} variant="dot">
                            <Avatar alt={selectedClass?.name} src="/static/images/avatar/1.jpg" />
                        </StyledBadge>
                    </Box>
                    <Stack spacing={0.2}>
                        <Typography variant='subtitle2'>{selectedClass?.name || "No Class Selected"}</Typography>
